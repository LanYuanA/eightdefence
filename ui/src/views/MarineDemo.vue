...
async function triggerEmergency() { if (!confirm('确认立即停止三台电机并锁定执行器？')) return; await marineApi.emergencyStop('演示员'); emergencyStopped.value = true; motors.value = await marineApi.listMotors(); notify('执行器急停已触发。', true) }
